...
export default function AppFrame({ children }: { children: React.ReactNode }) {
  ...
  return <div className="app-frame">
    ...
    <nav className="frame-mobile-nav" aria-label="Mobile navigation">
      {[["home","Home","/"],["study","Study","/study"],["practice","Practice","/practice"],["ai","AI","/ai"],["community","Community","/community"],["career","Career","/career"]].map(([type,label,href]) => <Link key={href} href={href} className={active(href) ? "active" : ""}><b><PremiumNavIcon type={type as "home" | "study" | "practice" | "ai" | "community" | "career"} /></b><small>{label}</small></Link>)}
    </nav>
    <LakshyaAI />
  </div>;
}
