...
export default function CommunityPage() {
  ...
  return <main className="community-page">
    <header className="community-header"><a href="/" className="back">← Dashboard</a><div><p>LAKSHYA COMMUNITY</p><h1>Learn together.</h1><span>Ask doubts, share notes, discuss preparation and find study partners.</span></div><button className="community-btn">+ New post</button></header>
    <div className="community-layout">
      <section>
        <div className="composer"><div className="avatar-small">K</div><textarea value={composer} onChange={e => setComposer(e.target.value)} placeholder="Ask a question or start a discussion..."/><div className="composer-bottom"><div><span># JEE</span><span># Boards</span><span># Doubts</span></div><button onClick={publish}>Post</button></div></div>
      ...
      <aside className="community-side"><div className="side-card"><p>DISCOVER</p><h2>Study spaces</h2><a href="#">JEE 2027 →</a><a href="#">Class 12 Boards →</a><a href="#">Physics Doubts →</a><a href="#">Chemistry Help →</a><a href="#">Mathematics →</a></div><div className="side-card"><p>SAFETY</p><h2>Keep it respectful.</h2><small>Community spaces are for learning. Report spam, harassment or unsafe content. Never share passwords, phone numbers, addresses or other private information.</small></div></aside>
    </div>
