...
function pdfFor(subject: string, chapter: string) {
  ...
  if (subject === "Physics") return `https://www.ncert.nic.in/textbook/pdf/${index < 7 ? "keph" : "leph"}${index < 7 ? index + 1 : index - 6}.0${index < 7 ? 1 : 1}.pdf`;
  if (subject === "Chemistry") return `https://www.ncert.nic.in/textbook/pdf/${index < 5 ? "kech" : "lech"}${index < 5 ? index + 1 : index - 4}.01.pdf`;
  return `https://www.ncert.nic.in/textbook/pdf/lebo1${index + 1}.pdf`;
}
