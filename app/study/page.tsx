...
export default function StudyPage(){
  ...
  return <main className="study-library">
    ...
    <style jsx>{`
      .study-library{max-width:1080px;margin:0 auto;padding:18px 28px 88px;min-height:100vh;background:linear-gradient(145deg,#fbfaff 0%,#f5f2ff 48%,#fff4fb 100%);animation:studyIn .35s ease both}
      ...
      .subject-list{display:grid;gap:11px}.subject-card{display:flex;align-items:center;gap:14px;padding:16px;border:1px solid #e2dfea;border-radius:18px;background:rgba(255,255,255,.9);text-decoration:none;color:#282633;box-shadow:0 6px 22px rgba(62,52,112,.05);transition:.22s ease}.subject-card:hover{transform:translateY(-2px);border-color:#c9c2ff;box-shadow:0 12px 28px rgba(78,65,160,.1)}
