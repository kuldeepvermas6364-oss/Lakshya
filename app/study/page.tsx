...
export default function StudyPage(){
  ...
  return <main className="study-library">
    ...
    <style jsx>{`
      ...
      .study-ai-menu{display:flex;align-items:center;gap:12px;margin:2px 0 13px;padding:12px 14px;border:1px solid #d9d1ff;border-radius:16px;background:linear-gradient(110deg,#f1edff,#fff0fb 55%,#eef8ff);text-decoration:none;color:#29263b;box-shadow:0 8px 24px rgba(91,73,170,.08);transition:.2s ease}.study-ai-menu:hover{transform:translateY(-1px);box-shadow:0 12px 28px rgba(91,73,170,.13)}.study-ai-menu-icon{width:40px;height:40px;border-radius:12px;display:grid;place-items:center;background:linear-gradient(135deg,#6552dc,#d14ad0);color:#fff;font-size:19px;box-shadow:0 5px 14px rgba(101,82,220,.25)}.study-ai-menu-copy{flex:1;min-width:0}.study-ai-menu-copy b,.study-ai-menu-copy small{display:block}.study-ai-menu-copy b{font-size:12px;font-weight:950;color:#4233a7}.study-ai-menu-copy small{font-size:8px;color:#858094;margin-top:3px;line-height:1.45}.study-ai-menu strong{font-size:21px;color:#6552dc}      .study-tabs{display:flex;gap:40px;height:50px;border-bottom:1px solid #e4e0eb;margin-bottom:15px}.study-tabs button{position:relative;border:0;background:transparent;padding:0 0 13px;font-size:15px;font-weight:900;color:#777383;cursor:pointer}.study-tabs button.active{color:#635bff}.study-tabs button.active:after{content:"";position:absolute;left:0;right:0;bottom:-1px;height:3px;border-radius:5px;background:#635bff}
