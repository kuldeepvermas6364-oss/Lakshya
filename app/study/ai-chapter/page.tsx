...
function ncertBookUrl(subject: string, chapter: string) {
  ...
  if (subject === "Physics") return index < 8 ? "https://ncert.nic.in/textbook.php?leph1=0-8&ln=hi" : "https://ncert.nic.in/textbook.php?leph2=0-6&ln=hi";
  ...
  if (subject === "Biology") return "https://ncert.nic.in/textbook.php?lebo1=0-13&ln=hi";
...
export default function AIChapterPage() {
  ...
  return <main className="page">
    ...
    <section className="card ncert"><div><span className="badge">🇮🇳 OFFICIAL NCERT • HINDI MEDIUM</span><h2>Hindi NCERT Chapter</h2><p>Official NCERT की Hindi textbook खोलो। NCERT page पर chapter PDF और complete-book PDF download विकल्प मिलता है। Lakshya NCERT पुस्तक की copy host नहीं करता।</p></div><div className="ncertActions"><a href={hindiNcertUrl} target="_blank" rel="noreferrer">📖 Hindi में NCERT खोलें</a><a href={hindiNcertUrl} target="_blank" rel="noreferrer">⬇ PDF / Download</a></div></section>
