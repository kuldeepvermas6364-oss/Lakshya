...
export default function ChapterWorkspacePage() {
  ...
  useEffect(() => {
    ...
    return onValue(
      ...
      () => setMessage("Saved items load नहीं हो सके / Saved items could not be loaded. Check Firebase rules.")
    );
  }, [user, workspaceKey]);
    ...
    <main className="workspace">
      <header>
        ...
        <div className="topActions">
          ...
          <button className="aiTopButton" onClick={focusAI}>✦ Lakshya AI / AI से पूछें</button>
          <Link className="secondary" href={`/study/ncert?subject=${encodeURIComponent(subject)}&chapter=${encodeURIComponent(chapter)}`}>NCERT Library / NCERT लाइब्रेरी</Link>
      ...
      <section className="ai aiHero" id="lakshya-ai">
        <div className="aiHeroTop">
          <div>
            <span className="badge">✦ LAKSHYA AI • AI STUDY MODE / AI पढ़ाई मोड</span>
            <h2>पूछो → समझो → Save करो / Ask → Understand → Save</h2>
            <p>Chapter के concepts AI से पूछें। फिर answer को MCQ, Flashcard, Key Point या Quick Revision में permanently save करें / Ask chapter concepts to AI, understand them, and save the answer for revision.</p>
          </div>
        ...
        {answer && <div className="answer">
          ...
          <div className="saveButtons">
            <button disabled={capturing !== null || saving} onClick={() => void captureWithAI("mcq")}>{capturing === "mcq" ? "Creating MCQ… / MCQ बन रहा है…" : "✦ AI → MCQ / MCQ बनाएं"}</button>
            <button disabled={capturing !== null || saving} onClick={() => void captureWithAI("flashcards")}>{capturing === "flashcards" ? "Creating Flashcard… / फ्लैशकार्ड बन रहा है…" : "✦ AI → Flashcard / फ्लैशकार्ड"}</button>
      ...
      {showNcert && <section className="ncertReader">
        <div className="readerHead">
          <div>
            ...
            <h2>{chapter}</h2>
            <p>Official NCERT PDF पढ़ें / Read the official NCERT PDF. अगर browser embedded PDF को block करे, तो <b>Open PDF / PDF खोलें</b> दबाकर पूरा PDF नए tab में खोलें.</p>
          </div>
          <div className="readerActions">
            <button className="aiReaderButton" onClick={focusAI}>✦ Lakshya AI / AI से समझें</button>
            <a href={pdfUrl} target="_blank" rel="noreferrer">Open PDF ↗ / PDF खोलें</a>
            <a href="https://ncert.nic.in/textbook.php" target="_blank" rel="noreferrer">NCERT Portal ↗ / NCERT पोर्टल</a>
          </div>
        </div>
        ...
        <div className="selectionBox">
          <div><b>Explain selected NCERT text with AI / चुना हुआ NCERT text AI से समझें</b><span>Official NCERT PDF browser security की वजह से directly read नहीं किया जा सकता। Text select/copy करके नीचे paste करें, फिर Lakshya AI उसे समझाएगा / The embedded PDF cannot be directly read because of browser security. Paste selected text below and Lakshya AI will explain it.</span></div>
      ...
      <section className="saved">
        <div className="savedHead"><div><span className="badge">YOUR CHAPTER MEMORY / CHAPTER MEMORY</span><h2>Saved inside this chapter / इस chapter में सेव</h2></div><small>Cloud saved / Cloud में सेव · {user ? "Synced / Sync हो रहा है" : "Sign in required / Sign in जरूरी"}</small></div>
