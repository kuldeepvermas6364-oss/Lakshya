  ...
  return (
    <main className="polli-page">
      <header className="polli-header">
        ...
        <div className="polli-brand"><span>✺</span><div><b>Pollinations AI</b><small>AI workspace</small></div></div>
        ...
        <div className="polli-messages">
          {messages.length === 0 ? (
            ...
            <article key={m.id} className={"polli-message " + m.role}>
              ...
              <div>
                <small>{m.role === "user" ? "YOU" : "POLLINATIONS AI"}</small>
                {m.content && <p>{m.content}</p>}
                {m.image && <img className="polli-generated-image" src={m.image} alt="Generated by Pollinations AI" />}
              </div>
            </article>
          ))}
